---
title: Drawer (shadcn-vue + Reka UI)
description: >-
  A drawer component for mobile devices.
component: true
links:
  shadcn-vue: https://shadcn-vue.com/docs/components/drawer
...
# or: npx shadcn-vue@latest add drawer
# or: yarn dlx shadcn-vue@latest add drawer
# or: bunx --bun shadcn-vue@latest add drawer
```
