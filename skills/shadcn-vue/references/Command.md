---
title: Command (shadcn-vue + Reka UI)
description: >-
  Fast, composable, unstyled command menu for Vue.
component: true
links:
  shadcn-vue: https://shadcn-vue.com/docs/components/command
...
# or: npx shadcn-vue@latest add command
# or: yarn dlx shadcn-vue@latest add command
# or: bunx --bun shadcn-vue@latest add command
```
