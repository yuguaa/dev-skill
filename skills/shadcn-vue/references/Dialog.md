---
title: Dialog (shadcn-vue + Reka UI)
description: >-
  A window overlaid on either the primary window or another dialog window, rendering the content underneath inert.
component: true
links:
  shadcn-vue: https://shadcn-vue.com/docs/components/dialog
...
# or: npx shadcn-vue@latest add dialog
# or: yarn dlx shadcn-vue@latest add dialog
# or: bunx --bun shadcn-vue@latest add dialog
```
