---
title: Range Calendar (shadcn-vue + Reka UI)
description: >-
  Presents a calendar view tailored for selecting date ranges.
component: true
links:
  shadcn-vue: https://shadcn-vue.com/docs/components/range-calendar
  reka-doc: https://reka-ui.com/docs/components/range-calendar
  reka-api: https://reka-ui.com/docs/components/range-calendar#api-reference
---
...
# or: npx shadcn-vue@latest add range-calendar
# or: yarn dlx shadcn-vue@latest add range-calendar
# or: bunx --bun shadcn-vue@latest add range-calendar
```
